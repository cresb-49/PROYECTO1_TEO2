            ...
            <form @submit.prevent="generarArticulo">
                ...
                <div class="row">
                    ...
                    <div class="col-4" v-if="enable_recompenza">
                        <div class="input-group mb-3">
                            <label for="precio" class="col-form-label" style="margin-right: 15px;">Recompenza</label>
                            <div class="input-group-text" style="border-radius: 5px 0px 0px 5px;">KOR</div>
                            <input type="number" step="0.01" class="form-control"
                                style="max-width: 200px;border-radius: 0px 5px 5px 0px;" v-model="recompenza" required>
                            <span class="input-group form-text">
    ...
    methods: {
        ...
        generarArticulo() {
            ...
            this.axios.post(`articulo`, payload, {
                ...
                // limpiamos las variables de creacion
                this.nombre = null;
                this.precio = 0.00;
                this.valor_entrada = 0.00;
                this.recompenza = 0.00;
                ...
                this.imagen = 'data:image/png;base64,';
                this.img = false;
            }).catch(error => {
