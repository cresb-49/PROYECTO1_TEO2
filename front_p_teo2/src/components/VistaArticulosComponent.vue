        ...
        <div id="contenedorProductos" style="margin-top: 20px;">
            <div class="row row-cols-1 row-cols-md-3 g-4">
                <template v-for="articulo in articulos" :key="articulo._1d">
                    <CardArticulo
                        :articulo="{ codigo: articulo.id, usuario: -1, nombre: articulo.articulo.nombre, precio: articulo.articulo.valor, imagen: articulo.articulo.id, descripcion: articulo.articulo.descripcion, categoria: 'articulo.categoria' }"
                        :comprar="true">
                    </CardArticulo>
                </template>
            </div>
